...
<div id="panel_edit_account" class="tab-pane active">
    ...
    <input type="hidden" name="record_id" id="record_id" value="{{ $servings['servingsize_id'] }}">
            ...
            <div class="col-md-6 ">
                <div class="form-group">
                    ...
                    @foreach($foods as $food)
                         <option value="{{$food->food_id}}" {{ ($food->food_id ==  $servings['food_id']) ? 'selected="selected"': ""}}>{{$food->short_desc}}</option>
                    @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" data-realtime="seq" required="required" name="seq" value="{{ $servings['seq'] }}" id="seq" type="text">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" data-realtime="serving_desc" required="required" name="serving_desc" value="{{ $servings['serving_desc'] }}" id="serving_desc" type="text">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" data-realtime="multiplier" required="required" name="multiplier" value="{{ $servings['multiplier'] }}" id="multiplier" type="text">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" data-realtime="serving_weight" required="required" name="serving_weight" value="{{ $servings['serving_weight'] }}" id="serving_weight" type="text">
                ...
                <div class="form-group">
                    <!--button class="btn btn-primary btn-wide pull-right btn-add-more-form update-client"-->
                        <button type="button" class="btn btn-primary btn-wide pull-right btn-add-more-form" id="update_servings"> Update 
                    </button>
                </div>
