...
@section('page-title')
<span >Waist Hip Ratio Calculator</span> 
@stop
...
<div class="panel-body">    
    ...
    <div class="row">
        ...
        <form id="form" class="waist-hip-ratio">
			...
			<button type="button"  id="Calculate-new" class="btn btn-primary button_waist">Calculate</button>
            <div class="form-group"></div>
            <button type="button" class="btn btn-primary button_waist_edit" id="Calculate-new">Edit</button>
            </div>
                    ...
                    <div class="">
                        ...
                        <div class="form-check">
                            <div class="form-check-label">
								...
								<input value="{{ $clientData['ratio'] }} %"  class="form-control-plaintext ratio" type="text" readonly>
                            </div>
                        </div>
                        </div>
                        <div class="counter-new">
                        <div class="form-check">
                            <div class="form-check-label">
								...
								<input value="{{ $clientData['bs'] }}" class="form-control-plaintext bs" type="text" readonly>
                            </div>
                        </div>
                        </div>		
						
                        <div class="counter-new counter-new-1">
                        <div class="form-check form-check-1">
                            <div class="form-check-label form-check-label-1">
                                <b class="">Interpretation :</b>
                                <b class="interpretation interpretation-1"></b>
								<input value="{{ $clientData['interpretation'] }}" class="form-control-plaintext" type="text" readonly style="display:none;">
                            </div>
                        </div>
                        </div>			
                    </div>
