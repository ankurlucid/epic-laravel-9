                        ...
                        <label class="container_radio version_2">
                           ...
                           <div class="showTimeBox">
                              <select id="daily_time_milestones">                                  
                                  ...
                                  <option value="8"  @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "8")) selected @endif>8:00 am</option>
                        ...
                        <label class="container_radio version_2">
                           ...
                           <div class="showDayBox">
                              <select id="weekly_day_milestones">
                                  <option value="Mon" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "Mon")) selected @endif>Mon</option>
                                  <option value="Tue" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "Tue")) selected @endif>Tue</option>
                                  <option value="Wed" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "Wed")) selected @endif>Wed</option>
                                  <option value="Thu" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "Thu")) selected @endif>Thu</option>
                                  <option value="Fri" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "Fri")) selected @endif>Fri</option>
                                  <option value="Sat" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "Sat")) selected @endif>Sat</option>
                                  <option value="Sun" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "Sun")) selected @endif>Sun</option>
                              </select>
                          </div>
                        </label>
                     </div>
                        ...
                        <label class="container_radio version_2">
                           ...
                           <div class="showMonthBox">
                              <select id="month_date_milestones">
                                <option value="1" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "1")) selected @endif>1</option>
                                <option value="2" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "2")) selected @endif>2</option>
                                <option value="3" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "3")) selected @endif>3</option>
                                <option value="4" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "4")) selected @endif>4</option>
                                <option value="5" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "5")) selected @endif>5</option>
                                <option value="6" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "6")) selected @endif>6</option>
                                <option value="7" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "7")) selected @endif>7</option>
                                <option value="8" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "8")) selected @endif>8</option>
                                <option value="9" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "9")) selected @endif>9</option>
                                <option value="10" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "10")) selected @endif>10</option>
                                <option value="11" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "11")) selected @endif>11</option>
                                <option value="12" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "12")) selected @endif>12</option>
                                <option value="13" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "13")) selected @endif>13</option>
                                <option value="14" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "14")) selected @endif>14</option>
                                <option value="15" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "15")) selected @endif>15</option>
                                <option value="16" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "16")) selected @endif>16</option>
                                <option value="17" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "17")) selected @endif>17</option>
                                <option value="18" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "18")) selected @endif>18</option>
                                <option value="19" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "19")) selected @endif>19</option>
                                <option value="20" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "20")) selected @endif>20</option>
                                <option value="21" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "21")) selected @endif>21</option>
                                <option value="22" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "22")) selected @endif>22</option>
                                <option value="23" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "23")) selected @endif>23</option>
                                <option value="24" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "24")) selected @endif>24</option>
                                <option value="25" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "25")) selected @endif>25</option>
                                <option value="26" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "26")) selected @endif>26</option>
                                <option value="27" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "27")) selected @endif>27</option>
                                <option value="28" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "28")) selected @endif>28</option>
                                <option value="29" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "29")) selected @endif>29</option>
                                <option value="30" @if(isset($milestonesData) && ($milestonesData[0]->gb_milestones_reminder_time == "30")) selected @endif>30</option>
                              </select>
                          </div>
                        </label>
                     </div>
