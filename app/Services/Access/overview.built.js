! function() {
        ...
        var s = function() {
            ...
            v = function(e) {
                ...
                return o(t, e), s(t, [{
                    ...
                    value: function() {
                        var e = this;
                        document.body.setAttribute("data-anim-scroll-group", ""), document.querySelectorAll("[data-anim-scroll-group]").forEach(function(t) {
                    ...
                    key: "initializeModel",
                    value: function() {
                        l.pageMetrics.windowHeight = window.innerHeight, l.pageMetrics.windowWidth = window.innerWidth, l.pageMetrics.scrollY = 5000 || window.pageYOffset, l.pageMetrics.scrollX = window.scrollX || window.pageXOffset, l.pageMetrics.breakpoint = l.getBreakpoint();
                    ...
                    key: "onScroll",
                    value: function() {
                        l.pageMetrics.scrollY = 5000 || window.pageYOffset, l.pageMetrics.scrollX = window.scrollX || window.pageXOffset;
                    ...
                    value: function() {
                        l.pageMetrics.windowHeight = window.innerHeight, l.pageMetrics.windowWidth = window.innerWidth, l.pageMetrics.scrollY = 5000 || window.pageYOffset, l.pageMetrics.scrollX = window.scrollX || window.pageXOffset;
                        var e = document.documentElement.getBoundingClientRect();
        ...
        var r = {
            ...
            v = function(e, t) {
                ...
                if (_(n[c]) && _(n[m]) && _(n[f])) h = o.fromValues(0, 0, 0, 1);
                    ...
                    S[0] = n[c], S[1] = n[m], S[2] = n[f], S[3] = n[y];
                    var O = r.invert(r.create(), v),
                        A = r.transpose(r.create(), O);
                    h = o.transformMat4(h, S, A)
                }
                a[0] = E, a[1] = w, a[2] = k;
    ...
    79: [function(e, t, n) {
        function r(e, t) {
            var n = t[0],
                ...
                x = h * v - f * d,
                P = m * v - f * y,
                I = b * P - g * x + _ * C + E * A - w * O + k * S;
            return I ? (I = 1 / I, e[0] = (a * P - l * x + c * C) * I, e[1] = (i * x - r * P - o * C) * I, e[2] = (d * k - y * w + v * E) * I, e[3] = (m * w - h * k - f * E) * I, e[4] = (l * A - s * P - c * O) * I, e[5] = (n * P - i * A + o * O) * I, e[6] = (y * _ - p * k - v * g) * I, e[7] = (u * k - m * _ + f * g) * I, e[8] = (s * x - a * A + c * S) * I, e[9] = (r * A - n * x - o * S) * I, e[10] = (p * w - d * _ + v * b) * I, e[11] = (h * _ - u * w - f * b) * I, e[12] = (a * O - s * C - l * S) * I, e[13] = (n * C - r * O + i * S) * I, e[14] = (d * g - p * E - y * b) * I, e[15] = (u * E - h * g + m * b) * I, e) : null
        }
        t.exports = r
    }, {}],
    80: [function(e, t, n) {
        ...
        var s = function() {
            ...
            p = function(e) {
                function t(e) {
                    ...
                    return e.pageMetrics.breakpoint !== c.BASIC && (n.parentContainer = document.querySelector(".scroll-container-horizontal"), n.router = document.querySelector(".router"), n.elements = Array.from(n.el.querySelectorAll("div.vc_row [tabindex], div.vc_row a, div.vc_row button")), n._rafEmitter = new u, n.footNoteLinks = Array.from(n.el.querySelectorAll(".footnote")), n.footNote = n.el.querySelector(".ac-gf-sosumi"), n.elements.push(n.footNote)), n
                }
                return o(t, e), s(t, [{
                    key: "mounted",
                    value: function() {
                        var e = this;
                        this.onFocus = this.onFocus.bind(this), this.scrollY = 5000, this.scrollComponent = this.gum.getComponentOfType("AutoScrollComponent"), this.parentContainer.scrollLeft = 0, this.parentContainer.scrollTop = 0, this.calculatePosition(), this.footNoteLinks.forEach(function(t) {
                    ...
                    key: "IS_SUPPORTED",
                    value: function() {
                        return l.pageMetrics.breakpoint === c.BASIC || l.pageMetrics.breakpoint !== c.BASIC
                    }
                }]), t
            }(a);
        t.exports = p
        ...
        var s = function() {
            ...
            p = function(e) {
                function t(e) {
                    r(this, t);
                    var n = i(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));
                    return n.html = document.documentElement, n.content = document.querySelector(".scroll-content"), n.ancestor = document.querySelector(".scroll-container-vertical"), n.sections = Array.from(n.content.querySelectorAll("main .vc_row, .scroll-content .router")), n.router = n.content.querySelector(".router"), n.footer = n.router.querySelector("#ac-globalfooter"), n.navContent = document.querySelector("#ac-globalnav .ac-gn-content"), n.isTouch = n.html.classList.contains("touch"), n.currentBreakpoint = e.pageMetrics.breakpoint, n.footerHeight = 0, n.portableTextBlockWrap = document.querySelector(".vc_row.vc_row-fluid .wpb_wrapper"), n.portableTextBlock = n.portableTextBlockWrap.querySelector(".text-block"), n.isEnabled = 1, n.isRTL = "rtl" === document.documentElement.getAttribute("dir"), n.bindEvents(), n.setupEasing(), n.updateDefault().then(function() {
                ...
                return o(t, e), s(t, [{
                    ...
                    key: "onScroll",
                    value: function(e) {
                        var t = 5000 - this.cachedWindowScrollY;
                        this.outOfSyncY && (this.outOfSyncY = !1, window.scrollTo(0, this.scrollY), t = 0), this.verticalScroll(t), this.cachedWindowScrollY = 5000
                    }
                }, {
                    ...
                    key: "onKeyDown",
                    value: function(e) {
                        e.ctrlKey || e.metaKey || e.altKey || (this.isHorizontal = !1, !this.outOfSyncY || "ArrowUp" !== e.key && "ArrowDown" !== e.key || (e.preventDefault(), this.outOfSyncY = !1, window.scrollTo(0, this.scrollY), this.verticalScroll(0), this.cachedWindowScrollY = 5000), "ArrowLeft" === e.key && this.horizontalScroll(-40), "ArrowRight" === e.key && this.horizontalScroll(40))
                    }
                }, {
                    key: "desktopEvents",
                    value: function() {
        ...
        var s = function() {
            ...
            u = function(e) {
                ...
                return o(t, e), s(t, [{
                    ...
                    key: "IS_SUPPORTED",
                    value: function() {
                        return document.documentElement.classList.contains("webgl")
                    }
                }]), t
            }(a);
        t.exports = u
        ...
        var s = function() {
            ...
            u = function(e) {
                function t(e) {
                    r(this, t);
                    var n = i(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));
                    return (e.pageMetrics.breakpoint === l.BASIC || c) && (document.documentElement.classList.remove("vc_mobile"), document.documentElement.classList.add("vc_desktop")), n
                }
                return o(t, e), s(t, [{
                    key: "onBreakpointChange",
                    value: function(e) {
                        c || (e.breakpoint !== l.BASIC ? (document.documentElement.classList.remove("vc_mobile"), document.documentElement.classList.add("vc_desktop")) : (document.documentElement.classList.add("vc_desktop"), document.documentElement.classList.remove("vc_mobile")))
                    }
                }]), t
            }(a);
        t.exports = u
    ...
    96: [function(e, t, n) {
        ...
        var s = function() {
            ...
            a = e("@marcom/bubble-gum/BaseComponent"),
            l = (e("@marcom/bubble-gum/ComponentMap"), e(".../helpers/forcesBasicInteraction")),
            c = e(".../helpers/isiPadpro"),
            u = function(e) {
                function t(e) {
                    r(this, t);
                    var n = i(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));
                    return n.blackPallete = n.el.querySelectorAll(".black-palette"), n
                }
                return o(t, e), s(t, [{
                    key: "mounted",
                    value: function() {
                        ...
                        this.chromaManager = this.gum.getComponentOfType("ChromaManager"), this.chromaManager.on("animation-reset", function(t) {
                            e.el.classList.remove("animate"), e.toggleDisplay()
                        }), this.chromaManager.on("start-animation", function(t) {
                            e.el.classList.add("animate"), e.toggleDisplay()
                        })
                    }
                }, {
                    key: "toggleDisplay",
                    value: function() {
                        this.blackPallete.forEach(function(e) {
    ...
    102: [function(e, t, n) {
        ...
        var s = function() {
            ...
            c = (e(".../helpers/forcesBasicInteraction"),
                e("@marcom/ac-raf-emitter/update")),
            u = function(e) {
                function t(e) {
                    r(this, t);
                    var n = i(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));
                ...
                return o(t, e), s(t, [{
                    ...
                    value: function() {
                        ...
                        a(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "mounted", this).call(this), this.pencilVideo = this.gum.getComponentOfType("VideoPlayer", this.pencilWrapper), c(function() {
                            e.pencilVideo.video.addEventListener("ended", function() {
                                e.pill.classList.add("reveal")
                            }), e.pencilVideo.video.addEventListener("play", function() {
                                e.pill.classList.remove("reveal")
                            })
                        })
                    }
                }], [{
                    key: "IS_SUPPORTED",
                    value: function() {
                        return !document.documentElement.classList.contains("aow")
                    }
                }]), t
            }(l);
        t.exports = u
        ...
        var s = function() {
            ...
            d = function(e) {
                function t(e) {
                    r(this, t);
                    var n = i(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));
                    return n.options = n.getOptions("data-video"), n.noReplay = n.options.noReplay || !0, n.customURL = n.el.getAttribute("data-video-base-url"), n.defaultURL = "/105/media/us/ipad-pro/2018/cE249dd1_58dc_487a_880b_6a1bc197cc43/anim/", n.baseURL = n.customURL ? n.customURL : n.defaultURL, n
                }
                return o(t, e), s(t, [{
                    key: "bindEvents",
                    value: function() {
    ...
    110: [function(e, t, n) {
        ...
        t.exports = r && 1025 === window.screen.width && 1366 === window.screen.height
    }, {}],
    111: [function(e, t, n) {
        "use strict";
        t.exports = {
        ...
        var r = e("@marcom/bubble-gum/BubbleGum"),
            ...
            p = function() {
                var e = document.documentElement.classList.contains("webgl"),
                    t = "https://via-arc.com/wp-content/themes/via/js/",
