...
@section('page-title')
<span >Body Fat YMCA Calculator</span> 
@stop
 ...
 <div class="panel-body">   
  <div class="alert alert-success" style="display:none"> </div>
    <div class="row">
        ...
        <form id="form" class="body-fat-ymca">
            ...
            <div class="form-group">
                <div class="">
                    <input type="number" class="form-control" placeholder="Waist (at navel)" name="waist" id="waist_m" value="{{ $clientData['waist'] }}" required>
                    <span id="waist" class="help-block" style="color: #a94442;display: none;" ></span>
                </div>
            </div>
            <button type="button"  id="Calculate-new"  class="btn btn-primary button_ymca">Calculate</button>
            <div class="form-group"></div>
            <button type="button" class="btn btn-primary button_ymca_edit" id="Calculate-new">Edit</button>
			</div>
