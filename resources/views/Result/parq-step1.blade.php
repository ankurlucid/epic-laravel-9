                            ...
                            <div id="middle-wizard">
                                <div class="step">
                                    <div class="row">
                                      ...
                                      <span class="qodef-grid-line-center heading-border"><span class="qodef-grid-line-inner" data-parallax="{&quot;y&quot;:750, &quot;smoothness&quot;:25}" style="transform: translate3d(0px, 0.024px, 0px) rotateX(90deg) rotateY(0deg) rotateZ(v) scaleX(1) scaleY(1) scaleZ(1);-webkit-transform: translate3d(0px, 0.024px, 0px) rotateX(90deg) rotateY(0deg) rotateZ(90deg) scaleX(1) scaleY(1) scaleZ(1);"></span>
         ...
         <img src="{{ dpSrc($clients->profilepic, $clients->gender)}}" class="clientPreviewPics clientpicPreviewPics previewPics" />
          <div class="form-group upload-group profileImage">
            ...
            <div>
                ...
                <label class="btn btn-primary btn-file webcamm">
...
<div class="modal mobile_popup_fixed" id="cropperModal" tabindex="-1" role="dialog" aria-labelledby="cropperModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
