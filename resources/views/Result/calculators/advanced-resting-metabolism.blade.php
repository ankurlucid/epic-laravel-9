...
@section('page-title')
<span >Advanced Resting Metabolism Calculator</span> 
@stop
...
<div class="panel-body">   
 <div class="alert alert-success" style="display:none"> </div>
    <div class="row">
        ...
        <form id="form" class="advanced-resting-metabolism">
            ...
            <button type="button" id="Calculate-new" class="btn btn-primary button_advance">Calculate</button>
            <div class="form-group"></div>
            <button type="button" class="btn btn-primary button_advance_edit" id="Calculate-new">Edit</button>
			</div>
                ...
                <div class="">
                    <div class="">
                        ...
                        <div class="form-check">
                            <div class="form-check-label"><span>
                                Resting Metabolism : 
                            </span>							<input class="form-control-plaintext arm" type="text" value="{{ $clientData['rm'] }} calories per day" readonly></div>
