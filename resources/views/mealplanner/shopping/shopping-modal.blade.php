              ...
              <table class="table table-hover">
                <tbody>
                 ...
                 @endforeach
                  ...
                  <button type="button" style="min-width: 144px;" class="btn btn-primary" id="UpdateShoppingList">Mark as purchased</button>
                  <button type="button" style="/* display:block; */min-width: 144px;background: white;color: #f94211;" class="btn btn-primary" id="deleteShoppingList">Delete</button>
