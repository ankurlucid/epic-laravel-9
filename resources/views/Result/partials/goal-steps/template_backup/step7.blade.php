  ...
  function loadFormData(){
     ...
     $.ajax({
         ...
         success: function (data) {
            ...
            if(data.data && data.data.accomplish_other != undefined && data.data.accomplish_other != ""){
              ...
              //  $('#accomplish_other').attr('placeholder','Describe your achievement Here...');
               $('#accomplish_other').text(data.data.accomplish_other);
            }
          }
     });
  }
    ...
    for (var i = 0; i < accomplish.length; i++) {
      ...
      if (accomplish[i] == "Other") {
        ...
        if (accomplish_other != null) {
          html3 =
            '<textarea rows="7" class="form-control" id="accomplish_other" name="accomplish_other">' +
            accomplish_other +
            "</textarea>";
        } else {
          html3 =
            '<textarea rows="7" class="form-control hidden" id="accomplish_other" name="accomplish_other"></textarea>';
        }
      }
