...
@section('page-title')
<span >Update Shopping Category</span> 
@stop
        ...
        <div class="row">
            <div class="col-md-6 ">
                <div class="form-group">
                    <div>
                        <label for="shopping_category" class="strong">Name </label>
                        <span class="epic-tooltip tooltipstered" rel="tooltip" data-toggle="tooltip" data-placement="left">
                            <i class="fa fa-question-circle"></i>
                        </span>
                    </div>
                    <input class="form-control" required="required" data-realtime="shopping_category" name="shopping_category" value="{{ $mCategory['shopping_category'] }}" id="shopping_category" type="text">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control rounded-0" data-realtime="shopping_category_desc" required="required" name="shopping_category_desc" id="shopping_category_desc" rows="10">{{ $mCategory['shopping_category_desc'] }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" required="required" data-realtime="shopping_order" name="shopping_order" value="{{ $mCategory['shopping_order'] }}" id="shopping_order" type="number">
                ...
                <div class="form-group">
                    <!--button class="btn btn-primary btn-wide pull-right btn-add-more-form update-client"-->
                        <button type="button" class="btn btn-primary btn-wide pull-right btn-add-more-form" id="update_shopcat"> Update 
                    </button>
                </div>
