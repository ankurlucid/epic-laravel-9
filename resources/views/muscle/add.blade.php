...
@section('breadcum')
    ...
    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Add Muscle</li>

@endsection

@section('breadcumTitle')

    <h6 class="font-weight-bolder mb-0">Add Muscle</h6>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header">
                    <h5 class="mb-0">Add Muscle</h5>
                    <p>Create new Muscle</p>
                </div>
                <div class="col-12 text-end">
                    <a class="btn bg-gradient-dark mb-0 me-4" href="{{ route('muscle.list') }}">Back to list</a>
                </div>
                <div class="card-body">
                    <form method='POST' action='{{ route('muscle.store') }}' class='FromSubmit d-flex flex-column align-items-center' enctype="multipart/form-data" id="add_muscle">
                    	@csrf
	                       {{--  <div class="avatar avatar-xxl position-relative">
	                            <div class="position-relative preview">
	                                ...
	                                <span class="h-12 w-12 rounded-full overflow-hidden bg-gray-100">
	                                    <img src="{{ asset('theme') }}/img/placeholder.jpg" alt="avatar"
                        ...
                        <div class="form-group col-12 col-md-6 mt-3">
                            ...
                            <input type="name" name='title' class="form-control border border-2 p-2"
                                id="exampleInputname" placeholder="Enter Muscle Name" value={{ old('name') }}>
                       ...
                       {{--  <div class="form-group col-12 mt-2 col-md-6">
	                        ...
	                        <div class="mt-3">
                                <img src="{{ asset('theme') }}/img/placeholder.jpg" class="image_2" width="150px" height="150px" />
                            </div>
                    	</div> --}}
                         <div class="form-group col-12 col-md-6 mt-3">
                        ...
                        <button type="submit" class="btn btn-dark mt-3">Add Muscle</button>
                    </form>
                </div>
            </div>
        </div>
