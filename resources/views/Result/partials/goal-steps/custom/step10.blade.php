<div class="step data-step" data-step="10">
  <div class="row">
   ...
   <div class="form-group">
      <input type="text" data-toggle="tooltip" title="" class="form-control vdp" id="start-datepicker" name="start_date"  autocomplete="off"  required data-provide="datepicker">
   </div>
  ...
  $("#datepicker_SYG").datepicker({
    ...
    format: 'D, d M yyyy',
      ...
      var minDate = new Date(selected.date.valueOf());
          minDate.setDate(minDate.getDate());  // for start date
          $("#goal_due_date").val(minDate);
        minDate.setDate(minDate.getDate() - 1);  
        // $("#goal_due_date").val(startDate);
