...
<div id="panel_edit_account" class="tab-pane active">
    ...
    <input type="hidden" name="record_id" id="record_id" value="{{ $foodInfo['food_id'] }}">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input class="form-control" required="required" data-realtime="short_desc" name="short_desc" value="{{ $foodInfo['short_desc'] }}" id="short_desc" type="text">
                    <span id="short_desc" class="help-block" style="color: #a94442;display: none;" ></span>
                </div>

                <div class="form-group">
                    <div>
                        <label for="food_desc" class="strong">Food Description *</label>
                        <span class="epic-tooltip tooltipstered" rel="tooltip" data-toggle="tooltip" data-placement="left">
                            <i class="fa fa-question-circle"></i>
                        </span>
                    </div>
                    <textarea class="form-control rounded-0" data-realtime="long_desc" required="required" name="long_desc" id="long_desc" rows="10">{{ $foodInfo['long_desc'] }}</textarea>
                ...
                <div class="form-group">
                    ...
                    @foreach($shoppingCat as $cat)
                         <option value="{{$cat->id}}" {{ ($cat->id ==  $foodInfo['shopping_category']) ? 'selected="selected"': ""}}>{{$cat->shopping_category_desc}}</option>
                    @endforeach
                    </select>
                    <!-- <input class="form-control" data-realtime="shopping_category" required="required" name="shopping_category" value="{{ $foodInfo['shopping_category'] }}" id="food_cat" type="text"> -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <div class="radio clip-radio radio-primary radio-inline m-b-0">
                                <input type="radio" name="is_drink" id="gridRadios1" value="1" {{ ( $foodInfo['is_drink'] == "1")? "checked" : "" }}>
                                <label for="gridRadios1"> Yes </label>
                            </div>
                            <div class="radio clip-radio radio-primary radio-inline m-b-0">
                                <input type="radio" name="is_drink" id="gridRadios2" value="0" {{ ( $foodInfo['is_drink'] == "0")? "checked" : "" }}>
        ...
        <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="water" name="water" value="{{ $foodInfo['water'] }}" id="water" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="energ_kcal" name="energ_kcal" value="{{ $foodInfo['energ_kcal'] }}" id="energ_kcal" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="protein" name="protein" value="{{ $foodInfo['protein'] }}" id="protein" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="lipid_total" name="lipid_total" value="{{ $foodInfo['lipid_total'] }}" id="lipid_total" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="ash" name="ash" value="{{ $foodInfo['ash'] }}" id="ash" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="carbohydrate" name="carbohydrate" value="{{ $foodInfo['carbohydrate'] }}" id="carbohydrate" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="fiber" name="fiber" value="{{ $foodInfo['fiber'] }}" id="fiber" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="sugar" name="sugar" value="{{ $foodInfo['sugar'] }}" id="sugar" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="calcium" name="calcium" value="{{ $foodInfo['calcium'] }}" id="calcium" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="iron" name="iron" value="{{ $foodInfo['iron'] }}" id="iron" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="magnesium" name="magnesium" value="{{ $foodInfo['magnesium'] }}" id="magnesium" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="phosphorus" name="phosphorus" value="{{ $foodInfo['phosphorus'] }}" id="phosphorus" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="potassium" name="potassium" value="{{ $foodInfo['potassium'] }}" id="potassium" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="sodium" name="sodium" value="{{ $foodInfo['sodium'] }}" id="sodium" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="zinc" name="zinc" value="{{ $foodInfo['zinc'] }}" id="zinc" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="copper" name="copper" value="{{ $foodInfo['copper'] }}" id="copper" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="manganese" name="manganese" value="{{ $foodInfo['selenium'] }}" id="manganese" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="selenium" name="selenium" value="{{ $foodInfo['selenium'] }}" id="selenium" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="vit_c" name="vit_c" value="{{ $foodInfo['vit_c'] }}" id="vit_c" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="thiamin" name="thiamin" value="{{ $foodInfo['thiamin'] }}" id="thiamin" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="riboflavin" name="riboflavin" value="{{ $foodInfo['riboflavin'] }}" id="riboflavin" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="niacin" name="niacin" value="{{ $foodInfo['niacin'] }}" id="niacin" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="panto_acid" name="panto_acid" value="{{ $foodInfo['panto_acid'] }}" id="panto_acid" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="vit_b6" name="vit_b6" value="{{ $foodInfo['vit_b6'] }}" id="vit_b6" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="folate" name="folate" value="{{ $foodInfo['folate'] }}" id="folate" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="folic_acid" name="folic_acid" value="{{ $foodInfo['folic_acid'] }}" id="folic_acid" type="text">
                 ...
                 <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="food_folate" name="food_folate" value="{{ $foodInfo['food_folate'] }}" id="food_folate" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="folate_dfe" name="folate_dfe" value="{{ $foodInfo['folate_dfe'] }}" id="folate_dfe" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="choline" name="choline" value="{{ $foodInfo['choline'] }}" id="choline" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="vit_b12" name="vit_b12" value="{{ $foodInfo['vit_b12'] }}" id="vit_b12" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="vit_aiu" name="vit_aiu" value="{{ $foodInfo['vit_aiu'] }}" id="vit_aiu" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="vit_arae" name="vit_arae" value="{{ $foodInfo['vit_arae'] }}" id="vit_arae" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="retinol" name="retinol" value="{{ $foodInfo['retinol'] }}" id="retinol" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="alphacarot" name="alphacarot" value="{{ $foodInfo['alphacarot'] }}" id="alphacarot" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="beta_carot" name="beta_carot" value="{{ $foodInfo['beta_carot'] }}" id="beta_carot" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="beta_crypt" name="beta_crypt" value="{{ $foodInfo['beta_crypt'] }}" id="beta_crypt" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="lycopene" name="lycopene" value="{{ $foodInfo['lycopene'] }}" id="lycopene" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="lut_zea" name="lut_zea" value="{{ $foodInfo['lut_zea'] }}" id="lut_zea" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="vit_e" name="vit_e" value="{{ $foodInfo['vit_e'] }}" id="vit_e" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="vit_dmcg" name="vit_dmcg" value="{{ $foodInfo['vit_dmcg'] }}" id="vit_dmcg" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="vivit_diu" name="vivit_diu" value="{{ $foodInfo['vivit_diu'] }}" id="vivit_diu" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="vit_k" name="vit_k" value="{{ $foodInfo['vit_k'] }}" id="vit_k" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="fa_sat" name="fa_sat" value="{{ $foodInfo['fa_sat'] }}" id="fa_sat" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="fa_mono" name="fa_mono" value="{{ $foodInfo['fa_mono'] }}" id="fa_mono" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="fa_poly" name="fa_poly" value="{{ $foodInfo['fa_poly'] }}" id="fa_poly" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="cholestrl" name="cholestrl" value="{{ $foodInfo['cholestrl'] }}" id="cholestrl" type="text">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" data-realtime="priority" name="priority" value="{{ $foodInfo['priority'] }}" id="priority" type="text">
            ...
            <div class="col-md-12">
                ...
                <!--button class="btn btn-primary btn-wide pull-right btn-add-more-form update-client"-->
                    <button type="button" class="btn btn-primary btn-wide pull-right btn-add-more-form" id="update_food"> Update
                </button>
                 </div>
            </div>
            </div>
