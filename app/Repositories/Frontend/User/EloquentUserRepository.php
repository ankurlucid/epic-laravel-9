...
class EloquentUserRepository implements UserContract
{
    ...
    public function create(array $data, $provider = false)
    {
        ...
        $check_items = ['client_management', 'business_support', 'Knowledge', 'resources', 'mentoring', 'agree'];
        ...
        if ($provider) {
            $user = User::create([
                ...
                'business_support' => $data['business_support'],
            ...
            //User::where('id', $user->id)->update(['account_id' => $user->id]);
