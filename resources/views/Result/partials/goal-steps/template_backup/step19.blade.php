<div class="step data-step newHabitForm" id="newHabitForm" data-step="19" data-habit="" data-habit-value="" data-value='0'>
                    <div class="row">
...
function templateLoad(){
   ...
   if(data.goal_template.goal_buddy_habit.length > 0){
      ...
      var habitData = data.goal_template.goal_buddy_habit[2]; //Assign Third habit data
