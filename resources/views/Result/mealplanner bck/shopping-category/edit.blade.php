        ...
        <div class="row">
            <div class="col-md-6 ">
                <div class="form-group">
                    ...
                    <input class="form-control" required="required" data-realtime="shopping_category_desc" name="shopping_category_desc" value="{{ $mCategory['shopping_category_desc'] }}" id="shopping_category_desc" type="text">
