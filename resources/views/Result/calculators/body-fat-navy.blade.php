...
@section('page-title')
<span >Body Fat Navy Calculator</span> 
@stop
...
<div class="panel-body">  
 <div class="alert alert-success" style="display:none"> </div> 
    <div class="row">
        ...
        <form id="form" class="body-fat-navy">
            ...
            <div class="form-group">
                <div class="">
                    <input type="number" class="form-control" placeholder="Waist (at narrowest for female, at naval for male)" name="waist" id="waist_m" value="{{ $clientData['waist'] }}" required>
                    <span id="waist" class="help-block" style="color: #a94442;display: none;" ></span>
                </div>
            </div>
            <div class="form-group" style="display: none;" id="hip">
                <div class="">
            ...
            <div class="form-group">
                <div class="">
                    <input type="number" class="form-control" id="neck_m" placeholder="Neck (at narrowest)" name="neck"  value="{{ $clientData['neck'] }}" required>
                    <span id="neck" class="help-block" style="color: #a94442;display: none;" ></span>
                </div>
            </div>
            <button type="button" id="Calculate-new" class="btn btn-primary button_navy">Calculate</button>
            <div class="form-group"></div>
            <button type="button" class="btn btn-primary button_navy_edit" id="Calculate-new">Edit</button>
			</div>
                    ...
                    <div class="">
                        ...
                        <div class="form-check">
                            <div class="form-check-label">
                                <span>Body Fat :</span>
								<input value="{{ $clientData['bf'] }} %" class="form-control-plaintext bf" type="text" readonly>
                            </div>
                        </div>
                        </div>
                        <div class="counter-new">
                        <div class="form-check">
                            <div class="form-check-label">
                                <span>Fat Mass :</span>
								<input value="{{ $clientData['fm'] }} unit" class="form-control-plaintext fm" type="text" readonly>
                            </div>
                        </div>
                        </div>		
                        ...
                        <div class="form-check">
                            <div class="form-check-label">
                                <span>Lean Mass :</span>
                                <input value="{{ $clientData['lm'] }} unit" class="form-control-plaintext lm" type="text" readonly>
                            </div>
                        </div>
                        </div>	
                        <div class="counter-new">
                        <div class="form-check">
                            <div class="form-check-label">
                                ...
                                <input value="{{ $clientData['bfc'] }}" class="form-control-plaintext bfc" type="text" readonly>
                            </div>
                        </div>
                        </div>			
                    </div>
