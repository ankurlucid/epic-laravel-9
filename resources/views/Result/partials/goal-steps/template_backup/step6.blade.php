<div class="step data-step" data-step="6">
                    <div class="row">
                      ...
                      <div class="heading-text border-head mb-10">
                        ...
                        <div class="watermark1" data-id="5"><span>5.</span></div>
                     ...
                     <div class="form-group">
                        ...
                        <input type="checkbox" name="life-change[]" class="life_change_reason other_life_change_reason" value="Other" id="other">
                        <span class="checkmark"></span>
...
<script type="text/javascript">
  $(document).ready(function() {
      templateLoad()
      loadFormData();
      $('#gb_change_life_reason_other').addClass('hidden');
      // $('#gb_change_life_reason_other').attr('required',false);
      // $("#gb_change_life_reason_other-error").html('');
      // $('#gb_change_life_reason_other').val('');
  });
  ...
  function loadFormData(){
     ...
     $.ajax({
         ...
         success: function (data) {
           console.log(data);
            if(data.data && data.data['life-change'] != undefined && data.data['life-change'].length > 0){
               data.data['life-change'].map(value => {
                  $("input[type=checkbox][value='"+value+"']").attr("checked",true);
              });
            }
            if(data.data && data.data.gb_change_life_reason_other != undefined && data.data.gb_change_life_reason_other != ""){
               $('#gb_change_life_reason_other').removeClass('hidden');
               $('#gb_change_life_reason_other').attr('required',true);
               // $('#gb_change_life_reason_other').attr('placeholder','Describe your achievement Here...');
               $('#gb_change_life_reason_other').text(data.data.gb_change_life_reason_other);
            }
          }
     });
  }
  $(document).on('change',".other_life_change_reason",function(){
   ...
   function templateLoad(){
      ...
      // if (fetch_data != null) {
      //    if (
      //    fetch_data.gb_change_life_reason != null &&
      //    fetch_data.gb_change_life_reason != ""
      //    ) {
