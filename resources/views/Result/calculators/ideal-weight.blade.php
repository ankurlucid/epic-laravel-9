...
<div class="panel-body">
   ...
   <div class="row">
    ...
    <div class="col-md-6 col-sm-12">
        ...
        <form id="form" class="ideal-weight">
            ...
            <div id="metric">
                <div class="form-group">
                    <div class="">
                        <input type="number" class="form-control" placeholder="Height (cm)" name="height-m" value="{{ $clientData['height_ft'] }}" id="height_m" required>
            ...
            <div id="imperial" style="display: none;">
             ...
             <button type="button" id="Calculate-new" class="btn btn-primary button_ideal">Calculate</button>
              <div class="form-group"></div>
            <button type="button" class="btn btn-primary button_ideal_edit" id="Calculate-new">Edit</button>
			</div>
                ...
                <div class="">
                    <div class="">
                        ...
                        <div class="form-check-label">
							<div class=""><span>Ideal Weight :</span><input class="form-control-plaintext ideal-weight" type="text" value="{{ $clientData['ideal_weight'] }} kg" readonly></div>
                        </div>
                        </div>
                        </div>
                    </div>
