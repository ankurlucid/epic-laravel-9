...
@section('content')
    {!! Form::model($permission, ['route' => ['administration.access.roles.permissions.update', $permission->id], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH']) !!}
        ...
        <div class="box box-success">
            <div class="box-body">
                <div class="pull-left">
                    <a href="{!! route('administration.access.roles.permissions.index') !!}" class="btn btn-danger btn-xs">{{ trans('buttons.general.cancel') }}</a>
                </div>
...
@section('after-scripts-end')
    {!! Html::script('js/backend/access/permissions/dependencies/script.js?v='.time()) !!}
@stop