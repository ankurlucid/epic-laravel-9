...
<div class="col-md-12 list list-mob list-{{ $i }}" data-id="{{ $i }}">
    <div class="row">
        ...
        <div class="col-md-2 col-xs-4">
            <span class="pull-right delete-ingr deleteIngrMob" data-val="{{ $formView }}" data-id="{{ $i }}"></span>
            <span class="pull-right edit-ingr editIngrMob"  data-val="{{ $formView }}" data-id="{{ $i }}"></span>
        </div>
    </div>
    <div class="line-ingr">
        <div class="row">
            ...
            <div class="col-md-4 edit-ing-{{ $i }}" style="display: none;">
                <div class="form-group text-right">
                    <a href="javascript:void(0)" class="btn btn-primary more updateRecipeIngrMob" data-val="{{ $formView }}" data-id="{{ $i }}">Update
                        Ingredient</a>
                    <a href="javascript:void(0)" class="btn btn-primary more edit-ingr-btn editIngrBtnMob"
        ...
        <div class="row">
            <div class="col-xs-12 text-center">
                <a href="javascript:void(0)" class="btn btn-primary more updateRecipeMob" data-val="{{ $formView }}" data-id="{{ $i }}">Update</a>
            </div>
        </div>
    </div>
  </div>
