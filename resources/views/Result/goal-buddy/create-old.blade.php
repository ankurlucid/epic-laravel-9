         ...
         <div id="wizard_container">
            ...
            <form id="wrapped" method="post" enctype="multipart/form-data">
              <input type="hidden" id="hbt_rec_tsk" value="none">
               ...
               <input type="hidden" class="form-control" id="task-index" name="task_index" value="0">
               ...
               {{-- <input type="hidden"  id="habit_form_validation"  value="0"> --}}
               ...
               <div id="middle-wizard">
                  ...
                  <div class="step data-step newGoalStep " data-step="1" data-value="0">
                     <div class="form-group">
                        ...
                        <input type="radio" name="chooseGoal" class="choose-create-new-goal-first" id="create_new_goal" value="create_new_goal" required>
                        <span class="checkmark"></span>
                        </label>
                     </div>
                     <div class="form-group">
                        <label class="container_radio version_2">CHOOSE FROM ONE OF OUR TEMPLATES 
                        <input type="radio" name="chooseGoal" id="choose_form_template" value="choose_form_template" required>
                        <span class="checkmark"></span>
                        </label>
                     </div>
                  </div>
                      ...
                      <span class="qodef-grid-line-center heading-border"><span class="qodef-grid-line-inner" data-parallax="{&quot;y&quot;:750, &quot;smoothness&quot;:25}" style="transform:translate3d(0px, 0.024px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); -webkit-transform:translate3d(0px, 0.024px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); "></span>
                        ...
                        <div class="heading-text border-head mb-10">
                          <div class="watermark1"><span>1.</span></div>
                           <label class="steps-head">Don't know how to define your goal? <br>Choose one from a  <strong>template:</strong>  </label>
                        </div>
  ...
  <div class="heading-text border-head mb-10">
                  ...
                  <div class="step data-step" data-step="6">
                    <div class="row">
                      ...
                      <div class="heading-text border-head mb-10">
                        ...
                        <label class="steps-head">By accomplish Your <strong>EPIC</strong> Goal how will your <strong>life change</strong>? </label>
                      </div>
                      ...
                      <div class="tooltip-sign mb-10">
                           ...
                           <b>Financial Situation—</b>How will my financial situation improve, will I be more confident, more efficient, be more proactive and do more which may result in a change of job, a promotion, or a pay increase?
                           <br/><br/>
                           <b>Other–</b> Add any other changes that achieving your <span style='color:#f64c1e;'> <b>EPIC</b> Goal </span> may result in this may be anything you believe will happen once you have achieved your desired <span style='color:#f64c1e;'>RESULT</span>.
                           "><i class="fa fa-question-circle question-mark"></i></a>
                      </div>
                     ...
                     <div class="form-group">
                        ...
                        <span class="checkmark"></span>
                        <textarea rows="7" class="form-control" id="gb_change_life_reason_other" name="gb_change_life_reason_other"></textarea>
                        </label>
                     </div>
                  </div>
                  <!-- /step-->
                  ...
                  <div class="step data-step milestoneData" data-step="14" data-value="0" >
                    ...
                    <div class="row dd-item m-30">
                     ...
                     <div class="row">
                     <div class="form-group new_Btn_milestone col-xs-10" data-new-milestones-id="">
                  ...
                  <div class="step data-step newHabitForm" id="newHabitForm" data-step="20" data-habit="" data-habit-value="" data-value='0'>
                    <div class="row">
                     ...
                     <div class="form-group ">
                        ...
                        <input onblur="validateGoalHabit()"  data-toggle="tooltip" title="" type="text" class="form-control" id="SYG_habits" value="{{isset($habitDetails)?$habitDetails->gb_habit_name:null}}" name="SYG_habits" required>
                     </div>
                  ...
                  <!-- /step--> --}}
                  <div class="step data-step newTask" data-step="21" data-value="0">
                    <div class="row">
                  ...
                  <!-- /step-->
                  <div class="step data-step taskNext newTaskData" data-step="22" data-value="0">
               ...
               <div class="submit step reviewGoal" data-step='24' id="end" data-next="0" data-value="0">
                     ...
                     <div class="form-group">
                           <div class="show_task-section well notes-section">
                             <h4>Notes:</h4>                 
                                <p>{{ !empty($goalDetails) && isset($goalDetails->gb_goal_notes) ? ucwords($goalDetails->gb_goal_notes) : ''}}</p>
                           </div>
                         </div> 
                  </div>
                  </div>
            ...
            <span class="qodef-grid-line-inner" data-parallax="{&quot;y&quot;:750, &quot;smoothness&quot;:25}" style="transform:translate3d(0px, 0.024px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); -webkit-transform:translate3d(0px, 0.024px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); "></span></span>
                ...
                <div class="col-sm-5 col-xs-5">
                   <button type="button" name="backward" class="backward">Prev</button></div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
         <h4 style='color: #f94211'><b>Enter notes</b></h4>
          <textarea class="form-control" id="goal_notes" name="describe_achieve" placeholder="General Notes"></textarea>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
      </div>
