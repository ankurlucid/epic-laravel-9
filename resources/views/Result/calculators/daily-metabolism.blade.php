...
@section('page-title')
<span >Daily Metabolism Calculator</span> 
@stop
...
<div class="alert alert-success" style="display:none"> </div>   
    <div class="row">
        ...
        <form id="form" class="daily-metabolism">
            ...
            <div class="form-group"><legend class="strong">Activity Level</legend>
                <div class="">
                    <div class="form-group">                       
                        <div>
                        ...
                        <div class="radio clip-radio clip-radio-new radio-primary radio-inline m-b-0">
                            <input type="radio" name="activity" id="gridRadios9" value="extremely-active" {{ ($clientData['activity'] == "extremely-active")? "checked" : "" }}>
            ...
            <button type="button" id="Calculate-new" class="btn btn-primary button_daily">Calculate</button>
            <div class="form-group"></div>
            <button type="button" class="btn btn-primary button_daily_edit" id="Calculate-new">Edit</button>
			</div>
                ...
                <div class="">
                    <div class="">
                        ...
                        <div class="form-check-label">
                                <span>Average Actual Metabolism :</span>
							<input class="form-control-plaintext aam" value="{{ $clientData['aam'] }} calories per day" type="text" readonly></div>
                        </div>
                        </div>
                        <div class="counter-new">
                        <div class="form-check">
                        <div class="form-check-label">
                                <span>Average Actual Metabolism Per Hour :</span>
                                <input class="form-control-plaintext aamph" value="{{ $clientData['aamph'] }} calories per hour" type="text" readonly></div>
                        </div>
                        </div>
                        <div class="counter-new">
                        <div class="form-check">
                        <div class="form-check-label">
                            <span class="">
                                Resting Metabolism:</span>
                                <input class="form-control-plaintext arm" value="{{ $clientData['arm'] }} calories per day" type="text" readonly>
                            </div>
                        </div>
                        </div>
    </div>        </form>
