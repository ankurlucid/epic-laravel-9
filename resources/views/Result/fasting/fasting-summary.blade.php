...
<div class="panel panel-white">
    ...
    <div class="fasting_mobile_details">
        ...
        <div class="complete_fasting">
            ...
            <div class="row">
                <div class="col-md-12">
                    <p>You successfully fasted for <strong> <span id='showHours'></span> hours and <span id='showMinutes'></span> minutes</strong>.</p>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="form-group">
                        <div class="fast_summery">
                            <p><strong>Start Fast</strong><br><span id='showStart'>{{getFastingEatingTimeFormate($start_fast)}}</span></p>
                            <a data-toggle="modal" data-target="#EditStartFastSummary" href="#">Edit Start Fast</a>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="fast_summery">
                            <p><strong>End Fast</strong><br><span id='showEnd'>{{getFastingEatingTimeFormate($end_fast)}}</span></p>
                        <a data-toggle="modal" data-target="#EditEndFastSummary" href="#">Edit End Fast</a>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-12">
                    <a href="#" class="btn endfast" id='saveFastButton'>Save Fast</a>
                </div>
            </div>
        </div>
        <!-- Fasting End -->
...
<div id="EditEndFastSummary" class="modal fade mobile_popup_fixed" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content animate-bottom">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">×</button>
                <h4 class="modal-title">Edit <span class="theme_color">End Fast</span></h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
...
$(document).on("click","#saveFastButton",function(){
    // window.alert(document.getElementById('sliderValue').innerHTML);
    // window.alert(document.getElementById('EndFastDate').value+' '+document.getElementById('EndFastTime').value);

    $.ajax({
        method: 'Post',
        url: public_url + 'save-fasting-summary',
        data: {
