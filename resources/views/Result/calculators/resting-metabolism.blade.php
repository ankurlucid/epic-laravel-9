...
@section('page-title')
<span >Resting Metabolism Calculator</span> 
@stop
...
<div class="alert alert-success" style="display:none"> </div>
    <div class="row">
        ...
        <form id="form" class="resting-metabolism">
            ...
            <div id="metric">
                ...
                <div class="form-group ">
                    <div class="">
                        <input type="number" class="form-control" placeholder="Lean Mass" name="mass-m" id="mass_m"  value="{{ $clientData['lmi'] }}" required>
                        <span id="lean_m" class="help-block" style="color: #a94442;display: none;" ></span>
                    </div>
                </div>
                <div class="form-group"><legend class="strong">Lean Mass In </legend>
                    <div class="">
                        <div class="form-group">
                        <div>
                          <div class="radio clip-radio radio-primary radio-inline m-b-0">
                                <input type="radio" name="unit-type-m" id="gridRadios3" value="percent" {{ ($clientData['lmi_type'] == "percent")? "checked" : "" }}>
                                <label for="gridRadios3"> Percent </label>
                            </div>
                            <div class="radio clip-radio radio-primary radio-inline m-b-0">
                                <input type="radio" name="unit-type-m" id="gridRadios4" value="unit" {{ ($clientData['lmi_type'] == "unit")? "checked" : "" }}>
                                <label for="gridRadios4"> Kilograms </label>
                            </div>
                        </div>
                    </div>
                    </div>
            ...
            <div id="imperial" style="display: none;">
                <div class="form-group ">
                    <div class="">
                        <input type="number" class="form-control" placeholder="Weight (lbs)" name="weight-i" id="weight_i" value="{{ $clientData['weight'] }}" required>
                        <span id="wei_i" class="help-block" style="color: #a94442;display: none;" ></span>
                    </div>
                </div>
                <div class="form-group ">
                    <div class="">
                        <input type="number" class="form-control" placeholder="Lean Mass" name="mass-i" id="mass_i"  value="{{ $clientData['lmi'] }}" required>
                        <span id="lean_i" class="help-block" style="color: #a94442;display: none;" ></span>
                    </div>
                </div>
                <div class="form-group">
                    <div class="">
                        ...
                        <div class="">
                            <div class="radio clip-radio radio-primary radio-inline m-b-0">
                                <input type="radio" name="unit-type-i" id="gridRadios5" value="percent" {{ ($clientData['lmi_type'] == "percent")? "checked" : "" }}>
                                <label for="gridRadios5"> Percent </label>
                            </div>
                            <div class="radio clip-radio radio-primary radio-inline m-b-0">
                                <input type="radio" name="unit-type-i" id="gridRadios6" value="unit" {{ ($clientData['lmi_type'] == "unit")? "checked" : "" }}>
                                <label for="gridRadios6"> Pounds </label>
                            </div>
            ...
            <button type="button" id="Calculate-new" class="btn btn-primary button_resting">Calculate</button>
            <div class="form-group"></div>
            <button type="button" class="btn btn-primary button_resting_edit" id="Calculate-new">Edit</button>
			</div>
                ...
                <div class="">
                    <div class="">
                        ...
                        <div class="form-check-label">
                            <span>Resting Metabolism :</span><input class="form-control-plaintext rm" value="{{ $clientData['rm'] }} calories per day" type="text" readonly></div>
                        </div>
                        </div>
                        <div class="counter-new">
                        <div class="form-check">
                        <div class="form-check-label">
                            <span>Lean Mass :</span>
							<input value="{{ $clientData['lm'] }} unit  ({{ $clientData['lmp'] }}%)" class="form-control-plaintext lm" readonly></div>
                        </div>
                        </div>
                        <div class="counter-new">
                        <div class="form-check">
                        <div class="form-check-label">
                            <span>Fat Mass :</span><input value="{{ $clientData['fm'] }} unit  ({{ $clientData['fmp'] }}%)" class="form-control-plaintext fm" type="text" readonly></div>
