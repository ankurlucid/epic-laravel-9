...
@section('content')
    {!! Form::model($role, ['route' => ['administration.access.roles.update', $role->id], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-role']) !!}
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    @include('administration.access.includes.partials.header-buttons')
                </div>
            </div><!-- /.box-header -->
        ...
        <div class="box box-success">
            <div class="box-body">
                <div class="pull-left">
                    <a href="{!! route('administration.access.roles.index') !!}" class="btn btn-danger btn-xs">{{ trans('buttons.general.cancel') }}</a>
                </div>
...
@section('after-scripts-end')
    {!! Html::script('js/backend/plugin/jstree/jstree.min.js?v='.time()) !!}
    {!! Html::script('js/backend/access/roles/script.js?v='.time()) !!}
