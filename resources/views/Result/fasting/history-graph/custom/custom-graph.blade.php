<style type="text/css">
 ...
 <div class="modal-header">
    ...
    <h4 class="modal-title">Edit <span class="theme_color ftype"> 
        @if($type == 'Fasting')
            FASTING TIME
        @else
            EATING TIME
...
<div class="modal-body">
    <div class="row">
        <form action="{{route('save-custom-fast-graph')}}" method="post" id="chunkForm">
            ...
            @else
                ...
                <div class="col-md-4 col-sm-4 col-xs-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="eating_start_date" value="{{ date('Y-m-d',strtotime($fastingData->start_eat))}}" id="eating_start_fast_date" class="date form-control" placeholder="Date">
                    </div>
                </div>
                <div class="col-md-2 col-sm-2 col-xs-2">
                    <div class="form-group">
                        <label>Start Time</label>
                        <input type="text" name="eating_start_time" value="{{ date('H:i',strtotime($fastingData->start_eat))}}" id="eating_start_fast_time" class="date form-control" placeholder="Time">
                    </div>
                </div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 text-center">
            <a class="addClass btn btn-primary" id='saveCustomData'>Update</a>
        </div>
    </div>
</div>

@include('Result.fasting.history-graph.custom.common_script')
