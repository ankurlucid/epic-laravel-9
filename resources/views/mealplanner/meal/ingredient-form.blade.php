            ...
            <div class="line-ingr">
                ...
                <div class="row edit-ing-{{ $i }}" style="display: none;">
                    ...
                    <div class="col-md-12 text-center">
                        <a href="javascript:void(0)" class="btn btn-primary more updateRecipeIngr" data-id="{{ $i }}">Update
                            Ingredient</a>
                ...
                <div class="row">
                    ...
                    @php
                        $new_val = isset($final_val['parsed'][0]) ? round($final_val['parsed'][0]['quantity'], 2) : 0;
                    @endphp
                        ...
                        <div class="form-group bg-white">
                            <select class="form-control food-measure-{{ $i }}">
                                <optgroup>
                                    ...
                                    @if(isset($final_val['hints'][0]))
                                    @foreach ($final_val['hints'][0]['measures'] as $key => $value)
                                        @if ( isset($final_val['parsed'][0]) && $value == $final_val['parsed'][0]['measure']['label'])
                                            <option value="{{ $value }}"
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <a href="javascript:void(0)" class="btn btn-primary more updateRecipe" data-id="{{ $i }}">Update</a>
                    </div>
                </div>
            </div>
        </div>
