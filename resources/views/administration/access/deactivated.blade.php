...
@section('page-title')
    Administration  <small>Deactivate User</small>
@stop()
                        ...
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-xs btn-success" href="{{ url('administration/access/user/'.$user->id.'/mark/1') }}">
                                        <i class="fa fa-play" data-original-title="Activate" data-toggle="tooltip" data-placement="top" title=""></i>
                                    </a>
