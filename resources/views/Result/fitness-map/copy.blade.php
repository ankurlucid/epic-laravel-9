...
<ul class="nav nav-tabs tabb">
  <li class="active"><a data-toggle="tab" href="#copy-route">Copy route</a></li>
</ul>
<div class="tab-content">
    <input type="hidden" id="polyline" value="{{ $data->polyline }}">
    <div id="copy-route" class="tab-pane fade in active">
                ...
                <div class="col-md-4 col-xs-12 col-sm-4">
                   <div class="undo-div">
                      <ul class="list-group">
                         ...
                         <li><a id="fitMapBtnSave" class="fitMapBtn" href="#"><i class="fa fa-check" aria-hidden="true"></i></a><span class="fitMapBtnText">Copy</span></li>
                      </ul>
                   </div>
                </div>
