<div class="submit step reviewGoal" data-step='31' id="end" data-next="0" data-value="0">
                           ...
                           <div class="vp-form-input-list p-l-0 padding-right-0">
                              ...
                              <div class="form-group Smart-review-check col-md-6 col-xs-12">
                                {{-- <div class="checkbox ind-checkbox prefTrainSlot @if(in_array('specific', $smartReview)) active @endif"> --}}
                                  ...
                                  <label class="container_check version_2">Specific
                                    <input id="Specific" name="Specific"  value="specific" required type="checkbox" >
                              ...
                              <div class="form-group Smart-review-check col-md-6 col-xs-12">
                                {{-- <div class="checkbox ind-checkbox prefTrainSlot @if(in_array('measurable', $smartReview)) active @endif"> --}}
                                  ...
                                  <label class="container_check version_2">Measurable
                                    {{-- <input type="checkbox" name="smart" value=""> --}}
                                    <input id="Measurable" name="Measurable" value="measurable" required type="checkbox">
                                    <span class="checkmark"></span>
                                    </label>
                              ...
                              <div class="form-group  Smart-review-check col-md-6 col-xs-12">
                                ...
                                <div class="checkbox ind-checkbox prefTrainSlot">
                                  ...
                                  <label class="container_check version_2">Attainable
                                    {{-- <input type="checkbox" name="smart" value=""> --}}
                                   <input id="Attainable" name="Attainable" value="attainable" required type="checkbox" >
                              ...
                              <div class="form-group  Smart-review-check col-md-6 col-xs-12">
                                ...
                                <div class="checkbox ind-checkbox prefTrainSlot">
                                  ...
                                  <input id="Relevant" name="Relevant"   value="relevant" required type="checkbox">
                              ...
                              <div class="form-group Smart-review-check col-md-6 col-xs-12">
                                ...
                                <div class="checkbox ind-checkbox prefTrainSlot">
                                  ...
                                  <label class="container_check version_2">Time-Bound
                                    {{-- <input type="checkbox" name="smart" value=""> --}}
                                   <input id="Time-Bound" name="Time-Bound" value="time_Bound" required type="checkbox" >
                     ...
                     <div class="form-group">
                         ...
                         <div class="">
                           <div class="show_task-section well habbit-section ">
                             <h4>Habits: <a href="#" id="edit_goal_habit" class="Step-your-goal3 edit_goal_element"> <i class="fa fa-pencil editable-pencil " style="color:#ff4401;"></i></a></h4>
                         ...
                         <div class="form-group">
                           <div class="show_task-section well task-section">
                             <h4>Tasks: <a href="#" id="edit_goal_task" class="Step-your-goal2 edit_goal_element"><i class="fa fa-pencil editable-pencil" style="color:#ff4401;"></i></a></h4>
