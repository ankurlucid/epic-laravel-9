...
<!--                <div id="calendEvent"></div>-->
                                    ...
                                    <div id="details_recur"></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <li class="col-xs-6 ui-widget-content ui-selectee" data-val="Confirmed">Confirmed</li>
                                                {!! Form::hidden('appointStatusOpt', 'Confirmed',['id' => 'appointStatusOpt']) !!}
                                            </ul> 
            ...
            <div class="modal-footer clearfix">
                ...
                <a class="btn btn-red pull-left unlink-prompt" href="#" id="unlinkClientClass">
                    <i class="glyphicon glyphicon-trash"></i>
                    Remove from <span class="bookingTypeName">class</span>
                </a> 
<!--                <a class="btn btn-red pull-left delete-prompt" href="#">
                ...
                <a class="btn btn-red pull-left delete-prompt-service" href="#">
                    <i class="glyphicon glyphicon-trash"></i>
                    Cancel Booking
                </a>
