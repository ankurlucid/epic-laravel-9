...
@section('page-title')
<span >Basal Metabolism Rate Calculator</span> 
@stop
...
<div class="panel-body">
    ...
    <div class="row">
        ...
        <form id="form" class="basal-metabolism-rate">
            ...
            <div class="form-group"><legend class="strong">BRM Equation Type </legend>
                <div class="">
                    <div class="form-group">
                        <div>
                        <div class="radio clip-radio radio-primary radio-inline m-b-0">
                            <input type="radio" name="equation" id="gridRadios5" value="mior" {{ ($clientData['equation_type'] == "mior")? "checked" : "" }}>
                            <label for="gridRadios5">  Mifflin - St Jeor </label>
                        </div>
                        <div class="radio clip-radio radio-primary radio-inline m-b-0">
                            <input type="radio" name="equation" id="gridRadios6" value="hact" {{ ($clientData['equation_type'] == "hact")? "checked" : "" }}>
                            <label for="gridRadios6"> Harris-Benedict </label>
                        </div>
                        </div>
                    </div>
            ...
            <div id="metric">
                <div class="form-group">
                    <div class="">
                        <input type="number" class="form-control" placeholder="Weight (kg)" name="weight-m" value="{{ $clientData['weight'] }}" id="weight_m" required>
			...
			<button type="button" class="btn btn-primary button_basal" id="Calculate-new">Calculate</button>
            <div class="form-group"></div>
            <button type="button" class="btn btn-primary button_basal_edit" id="Calculate-new">Edit</button>
            </div>
                ...
                <div class="">
                    <div class="">
                        ...
                        <div class="form-check">
							<div class=""><span>BRM :</span><input class="form-control-plaintext bmr" value="{{ $clientData['brm'] }}" type="text" readonly></div>
                        </div>
                        </div>
                    </div>
                </div>
...
@section('script')
    <script>
            ...
            $('#form').on('submit', function (e) {
                ...
                $.ajax({
                    url: "{{ route('basal-metabolism-rate') }}",
                    type: 'post',
                    processData: false,
                    contentType: false,
