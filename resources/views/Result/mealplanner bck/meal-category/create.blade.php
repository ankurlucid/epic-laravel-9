        ...
        <div class="row">
            <div class="col-md-6 ">
                <div class="form-group">
                    ...
                    <input class="form-control" required="required" data-realtime="mealcategoryDesc" name="mealcategoryDesc" value="" id="mealcategoryDesc" type="text">
                ...
                <!-- <div class="form-group">
                    ...
                    <textarea class="form-control rounded-0" data-realtime="mealcategoryDesc" required="required" name="mealcategoryDesc" value="" id="mealcategoryDesc" rows="10"></textarea>
                    <span id="mealcategoryDesc" class="help-block" style="color: #a94442;display: none;" ></span>
                ...
                <div class="form-group">
                    <!--button class="btn btn-primary btn-wide pull-right btn-add-more-form update-client"-->
                        <button type="button" class="btn btn-primary btn-wide pull-right btn-add-more-form" id="add_meal_category"> Add
                    </button>
                </div>
