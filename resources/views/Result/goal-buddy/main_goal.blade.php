...
<head>
    ...
    @yield('meta')
    <link rel="stylesheet" type="text/css" href="{{asset('result/parq-theme/style.css?v='.time())}}">
...
<script type="text/javascript">
    ...
    {{-- <div class="backto_dashboard">
        <button type="button" name="" class="btn">Back to Dashboard</button>
    </div> --}}
    ...
    <!-- <script src="{{asset('result/parq-theme/goal_wizard.js?v='.time())}}"></script> -->
    ...
    {!! Html::script('result/js/goal-process/manage-steps.js?v='.time()) !!}
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        console.log("main_goal.blade.php");
    });
